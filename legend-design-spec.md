...
> **Version:** 1.8 | **Created:** Multi-4 · 3 Aug 2026 | **Updated:** Multi-[n] restructure · 25 Aug 2026
...
> modal inventory, theme behaviour, navigation, funding model, status page.
> UI mode specs (Distress, Stewardship, Legacy print, Verification, Recipient View,
> Treasury Watch, Watch Recipient View) are in `legend-ui-modes.md`.
> Appendix (session roadmap, post-B9 scope additions) is in `legend-design-appendix.md`.
...
Five discrete states, each replacing the last. Text updates only — no spinner, no animation beyond text change. This is honest about what the infrastructure is doing. Exact strings in `legend-copy-index.md` §8.
...
The degraded mode banners (Section 7 of `legend-copy-index.md`) do not link to
